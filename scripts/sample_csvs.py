...
For each subdirectory containing direct CSVs in /Users/lilache/PycharmProjects/CLEAR/scripts/runs:
...
def main():
    base_path = Path('/Users/lilache/PycharmProjects/CLEAR/scripts/runs/input_all')
    output_base = Path('/Users/lilache/PycharmProjects/CLEAR/scripts/runs/input')
